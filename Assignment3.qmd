...
**\[3 Marks\]** Modify your JAGS code to create simulated datasets, `yrep`, used for posterior predictive checking. Then,
...
**\[7 Marks\]** What is the median estimate and 95% prediction interval for an outcome when the point spread is 16?
