...
## Output from MCMC {style="font-size: 70%;"}
...
## Output from MCMC: trace plots {style="font-size: 70%;"}
...
## Output from MCMC: joint parameter plots {style="font-size: 70%;"}
...
## Output from MCMC: density plots and summaries {style="font-size: 70%;"}
