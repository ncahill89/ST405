...
We want to know what the sample size of a non-autocorrelated chain would be. An answer to this question can be provided with a measure called *effective sample size (ESS)*
...
-   Thinning by a factor of *k*: Retain \[ x_k, x\_{2k}, x\_{3k}, ... \]
