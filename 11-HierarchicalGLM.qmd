...
subtitle: "A Bayesian Hierarichal GLM Case Study"
...
-   An estimate of the true (but unknown) relative risk is denoted by $\theta_i$ in county $i$.
...
$$\lambda_i = \theta_i e_i$$ $$log(\theta_i) = \alpha_i + \beta(x_i - \bar{x})$$ $$\alpha_i|\mu_{\alpha},\sigma_{\alpha} \sim N(\mu_{\alpha},\sigma_{\alpha})$$
